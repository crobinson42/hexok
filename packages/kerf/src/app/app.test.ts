...
describe('CheckUseCase', () => {
  it('names missing static ports, on, and catalog', () => {
    ...
    >().toEqualTypeOf<`kerf: ApiUseCase "missing.ports" is missing static ports`>();
    expectTypeOf<
      CheckUseCase<typeof MissingOn>
    >().toEqualTypeOf<`kerf: EventUseCase "missing.on" is missing static on`>();
    expectTypeOf<
      CheckUseCase<typeof MissingCatalog>
    >().toEqualTypeOf<`kerf: EventUseCase "missing.catalog" is missing static catalog`>();
  ...
  it('rejects static on that is not in the catalog Events', () => {
    ...
    >().toEqualTypeOf<`kerf: EventUseCase "mismatch" static on is not in catalog`>();
    expectTypeOf<
      CheckUseCase<typeof OnEmpty>
    >().toEqualTypeOf<`kerf: EventUseCase "on.empty" static on is not in catalog`>();
...
describe('deriveContract', () => {
  ...
  it('throws on duplicate key', () => {
    ...
    ).toThrow('kerf: duplicate use-case key "incident.close"');
  });
